...
import 'package:kk_movie_app/presentation/category//pages/categories_page.dart';
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final movieType = state.extra as MovieType;
          return BlocProvider(
            create: (_) => ViewAllCubit(movieType: movieType),
            child: ViewAllPage(movieType: movieType),
          );
        },
      ),
