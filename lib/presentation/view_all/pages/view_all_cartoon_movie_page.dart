...
class ViewAllCartoonMoviePage extends StatefulWidget {
  const ViewAllCartoonMoviePage({super.key});

  @override
  State<ViewAllCartoonMoviePage> createState() =>
      _ViewAllCartoonMoviePageState();
}

class _ViewAllCartoonMoviePageState extends State<ViewAllCartoonMoviePage> {
  ...
  void _onScroll() {
    ...
    if (!state.isLoadingPage &&
      ...
      context.read<ViewAllCubit>().getViewAllCartoonMovie();
    }
  }
      ...
      body: SafeArea(
        child: BlocBuilder<ViewAllCubit, ViewAllState>(
          ...
          builder: (context, state) {
            ...
            if (state.errorViewAllCartoonMovie != null) {
  ...
  Widget _viewAllCartoonMovie(
    ...
    strokeWidth: 2.0,
    onRefresh: () async {
      await context.read<ViewAllCubit>().resetCartoonMovie();
